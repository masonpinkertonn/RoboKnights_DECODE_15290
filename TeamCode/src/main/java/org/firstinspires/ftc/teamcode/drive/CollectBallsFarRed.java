...
@Config
@Autonomous(name = "Red - Far Auto Ball Collection")
public class CollectBallsFarRed extends OpMode {
    ...
    public static PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(0.0015, 0, 0.0000025);
    ...
    public void init() {
        ...
        mySequence = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .forward(50)
                .waitSeconds(50)*/
                .lineToLinearHeading(new Pose2d(0, 0, Math.toRadians(225)))
                .addTemporalMarker(() -> {
